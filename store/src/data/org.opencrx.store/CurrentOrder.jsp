...
<%
    ...
    if( requestHelper.getActionType().equals( ACTION_TYPE ) )
    {
        ...
        {
            final OrderManager manager = new OrderManager(sessionHelper.getOpenCrxContext());
    ...
    if( sessionHelper.isUserLoggedIn() )
    {
        ...
        if( null != order && ( order.getStatus() == Order.STATUS_BUYING ) )
        {
            ...
            final ObjectCollection items = itemManager.getItemsInOrder( order.getKey() );
...
<form method=POST action="<%= ResponseHelper.CHANGE_QUANTITY_JSP %>" >
            ...
            final Iterator iterator = items.objects().iterator();
