<%@ page import="org.opencrx.store.common.ObjectCollection,
                 org.opencrx.store.common.util.RequestHelper,
                 org.opencrx.store.manager.CategoryManager,
                 org.opencrx.store.common.PrimaryKey,
                 java.util.Iterator,
                 org.opencrx.store.objects.Category,
                 java.util.Vector,
                 java.util.ArrayList,
...
<%
    ...
    final CategoryManager catMan = new CategoryManager(sessionHelper.getOpenCrxContext());
    ...
    final ObjectCollection categories = catMan.getChildren( categoryID );
...
<%
    ...
    // 5. Render categories
    if( categories.objects().size() > 0 )
    {
%>
<dl style="width:480px;">
<%
        final Iterator iter = categories.objects().iterator();
        while (iter.hasNext())
        {
