...
:start
if exist "@@INSTALLDIR@@\opencrx\data\crx_2_7\startdb.bat" (
  start "HSQLDB" "@@INSTALLDIR@@\opencrx\data\crx_2_7\startdb.bat" START
  ping 127.0.0.1 > nul  
)
set JAVA_OPTS=%JAVA_OPTS% -Dopencrx.CRX.jdbc.driverName=org.hsqldb.jdbcDriver
set JAVA_OPTS=%JAVA_OPTS% -Dopencrx.CRX.jdbc.url=jdbc:hsqldb:hsql://127.0.0.1:@@HSQLDB_PORT@@/CRX_2_7
...
if exist "@@INSTALLDIR@@\opencrx\data\crx_2_7\startdb.bat" (
	start "HSQLDB" "@@INSTALLDIR@@\opencrx\data\crx_2_7\startdb.bat" STOP
)
goto end
