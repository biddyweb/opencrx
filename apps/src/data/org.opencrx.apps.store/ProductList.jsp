<%@ page import="org.opencrx.apps.store.common.PrimaryKey,
 ...
 <%--
  Shows list of products under the current category
...
<%
    ...
    final ObjectCollection collection = productManager.getInCategory( categoryID );
...
<%
    final Iterator iterator = collection.objects().iterator();
